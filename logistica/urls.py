...
urls_LastmileB2C = [
    ...
    path('ip/<str:code>/', trackingIPV2, name='pcp'),
    path('ip/<str:code>/', trackingIPV2, name='retorno_picking'),
    path('ip/<str:code>/', trackingIPV2, name='consolidacao'),
    path('ip/<str:code>/', trackingIPV2, name='expedicao'),
    path('ip/<str:code>/', trackingIPV2, name='troca_custodia'),
