...
urls_LastmileB2C = [
    ...
    path('ip/<str:code>/', trackingIPV2, name='pcp_simpl'),
    path('ip/<str:code>/', trackingIPV2, name='retorno_picking_simpl'),
    path('ip/<str:code>/', trackingIPV2, name='consolidacao_simpl'),
    path('ip/<str:code>/', trackingIPV2, name='expedicao_simpl'),
    path('ip/<str:code>/', trackingIPV2, name='troca_custodia_simpl'),
