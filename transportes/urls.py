...
from .views import lista_viagens, detalhe_viagem, criar_os_transp, buscar_locais, skill_customer, skill_transport, driver_ger, vehicle_ger, atribuir_motorista_viagens_manual
