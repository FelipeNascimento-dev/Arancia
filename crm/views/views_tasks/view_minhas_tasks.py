...
def minhas_tasks(request):
    ...
    return render(
        request,
        "crm/templates_tasks/minhas_tasks.html",
        {
            "site_title": "CRM — Minhas Tasks",
            "items": items,
            "pagination": pagination,
            "filters": filters,
            "lookups": lookups,
            "list_mode": "mine",
            **menu_context("projetos_tasks", "minhas"),
        },
    )
