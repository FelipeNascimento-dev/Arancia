...
urlpatterns = [
    ...
    path("crm/contracts/new/", form_contrato, name="form_contrato"),
    ...
    path("crm/billing/new/", form_faturamento, name="form_faturamento"),
    path("crm/billing/<str:billing_id>/edit/", form_faturamento, name="edit_faturamento"),
