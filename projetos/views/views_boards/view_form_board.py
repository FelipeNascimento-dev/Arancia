...
def form_board(request, board_id=None):
        ...
        if form.is_valid():
            try:
                ...
                if is_edit:
                    ...
                    return redirect("projetos:kanban_board", board_id=board_id)
                ...
                if new_id:
                    return redirect("projetos:kanban_board", board_id=new_id)
                return redirect("projetos:lista_boards")
            except CrmApiError as exc:
                messages.error(request, crm_error_message_pt(exc))
        else:
    ...
    return render(
        request,
        "projetos/templates_boards/form_board.html",
        {
            "site_title": f"Projetos — {'Editar' if is_edit else 'Novo'} Board",
            "form": form,
            "is_edit": is_edit,
            "board_id": board_id,
            "board": board,
